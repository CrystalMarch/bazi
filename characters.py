...
femaleNames = set(
    list([
        '灵', '照', '语', '汝', '俏', '蕾', '女', '文', '思', '均', '榕', '晶', '仙', '梓',
        '珠', '蔚', '徽', '韫', '娆', '玥', '恩', '贤', '玄', '肖', '雁', '玉', '蒙', '跃',
        '诺', '珏', '曾', '蔓', '雅', '密', '原', '扬', '俪', '诚', '昀', '苑', '亚', '一',
        '颜', '意', '华', '情', '媚', '嵩', '瓤', '弛', '裕', '琼', '芹', '烟', '彩', '缨',
        '纨', '忻', '姬', '彬', '书', '夏', '皓', '良', '懿', '亭', '嫣', '雪', '翊', '胤',
        '珑', '蕊', '侃', '双', '笑', '秦', '荃', '允', '辰', '巍', '燕', '奕', '渊', '芳',
        '潇', '愉', '希', '旗', '倩', '葳', '娴', '素', '丛', '郁', '溪', '汀', '楚', '星',
        '霞', '夕', '蓓', '牧', '纬', '熠', '励', '衍', '萍', '茉', '苇', '卿', '芙', '蝶',
        '展', '澄', '蓝', '盈', '飒', '萌', '昭', '盼', '珂', '贝', '寒', '融', '策', '砚',
        '美', '斐', '齐', '俞', '筠', '琛', '香', '靓', '沫', '昱', '秀', '顺', '枝', '杭',
        '贞', '晔', '箐', '业', '妤', '微', '西', '卫', '旖', '音', '畅', '骁', '予', '森',
        '珩', '耀', '旎', '频', '钧', '馨', '伊', '单', '珊', '辛', '痴', '晖', '尔', '爱',
        '佳', '艾', '诗', '芄', '焕', '盛', '婕', '君', '矫', '来', '欢', '尧', '馥', '幼',
        '润', '飚', '利', '鸿', '爽', '叶', '菊', '宛', '雯', '台', '杏', '蓉', '申', '韶',
        '沛', '泓', '轶', '苗', '游', '闪', '凝', '琳', '鑫', '妙', '舒', '俐', '天', '黛',
        '斌', '妃', '妲', '宾', '谨', '竹', '朦', '冬', '征', '甜', '恺', '飘', '翎', '娥',
        '前', '益', '含', '婵', '凛', '茹', '霏', '洲', '芮', '苑', '霁', '晏', '嫒', '露',
        '朔', '程', '衡', '恋', '醒', '易', '引', '珉', '月', '萃', '米', '松', '枫', '韵',
        '鹭', '苹', '立', '璧', '钦', '娇', '沙', '帆', '丰', '闻', '滢', '烨', '琪', '媛',
        '旋', '若', '玢', '葡', '满', '群', '朝', '桑', '彤', '玎', '净', '烁', '葵', '桔',
        '凤', '苏', '晓', '清', '童', '桦', '姝', '妍', '南', '梦', '泳', '淳', '瑕', '拉',
        '冶', '实', '格', '礼', '默', '璇', '喆', '柯', '智', '翼', '兰', '陶', '维', '娉',
        '樱', '钰', '林', '寅', '端', '娓', '嫚', '蕙', '熹', '瑾', '紫', '悦', '依', '明',
        '贺', '培', '栩', '韦', '昂', '越', '遥', '尉', '荣', '娟', '平', '郦', '知', '言',
        '冠', '新', '眉', '渝', '熙', '谦', '咏', '海', '晰', '心', '望', '莲', '芬', '源',
        '弘', '妮', '佩', '典', '沁', '垚', '震', '璐', '春', '如', '莎', '丹', '祯', '嫱',
        '尤', '缘', '幸', '花', '琬', '会', '品', '田', '臻', '岑', '睿', '小', '菡', '捷',
        '茵', '筱', '凡', '岳', '碧', '璟', '琴', '菁', '怡', '非', '苓', '茜', '欣', '聪',
        '乐', '川', '桐', '洋', '余', '娅', '珺', '营', '霭', '恒', '洵', '洺', '迪', '颢',
        '菱', '曦', '蔷', '凌', '白', '郡', '总', '簧', '驰', '泉', '岩', '优', '菲', '季',
        '飞', '粼', '湘', '豫', '椒', '恬', '禾', '绮', '军', '芊', '锦', '姣', '念', '祥',
        '淑', '风', '冰', '玫', '秋', '京', '杉', '铃', '舟', '暖', '柔', '艺', '锐', '映',
        '正', '麟', '鹂', '千', '方', '盟', '庆', '茂', '颖', '攀', '灿', '娣', '绚', '雄',
        '煦', '璜', '吉', '喻', '晨', '萱', '璞', '朋', '颉', '蝴', '鸽', '妹', '慈', '艳',
        '皎', '迅', '霜', '滨', '延', '云', '雨', '容', '涓', '迎', '涵', '慕', '玮', '岚',
        '果', '漫', '真', '屏', '霓', '瀛', '肠', '芸', '昕', '虹', '城', '琦', '珍', '巧',
        '楠', '瑗', '铭', '玲', '丽', '艳', '静', '歆', '也', '敏', '宝', '慧', '晗', '英',
        '翀', '颐', '嘉', '霖', '乔', '裙', '杨', '纯', '筝', '浩', '朵', '成', '吟', '黎',
        '汇', '鹃', '为', '霄', '嵘', '麒', '丁', '祺', '勉', '婧', '晴', '羽', '龙', '好',
        '或', '桥', '严', '园', '然', '想', '琚', '芯', '荟', '影', '洁', '桃', '蕴', '琰',
        '津', '莺', '姿', '莹', '野', '鸥', '枚', '斯', '荔', '唯', '笛', '喜', '婉', '钥',
        '溢', '元', '仪', '宜', '赞', '姗', '堃', '金', '安', '宁', '惟', '永', '毓', '劼',
        '颇', '珣', '忠', '多', '逸', '圆', '魏', '茗', '敬', '桂', '薇', '咪', '荷', '惠',
        '子', '炜', '赉', '翠', '曼', '莉', '囡', '亮', '瑜', '梅', '连', '行', '红', '颍',
        '澜', '毅', '联', '令', '蜜', '忆', '娜', '芝', '胜', '航', '国', '柳', '漪', '育',
        '弦', '信', '旻', '尚', '俭', '忱', '可', '殷', '环', '瑛', '卉', '谊', '隽', '青',
        '婷', '瑶', '桢', '伶', '学', '焱', '赫'
    ]))
